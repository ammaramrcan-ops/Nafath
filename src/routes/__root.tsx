...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Lovable App" },
      { name: "description", content: "Adaptive Learning Hub is an interactive web application for modern, progressive learning experiences." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Lovable App" },
      { property: "og:description", content: "Adaptive Learning Hub is an interactive web application for modern, progressive learning experiences." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Lovable App" },
      { name: "twitter:description", content: "Adaptive Learning Hub is an interactive web application for modern, progressive learning experiences." },
