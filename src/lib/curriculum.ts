  ...
  "blocks": [
    {
      ...
      "steps": {
        "step1_story": "الخطوة 1: 📖 القصة والحل الشرعي مع دليل السنة النبوية - قصة تشبيهية عامية طريفة بالبلدي تشرح المفهوم بأسلوب دايركت وممتع، مع دليل من السنة النبوية",
        "step2_attention": "الخطوة 2: 💡 فقرة 'خد بالك منها' - نقاط تأهيل واستبصار فقهي ذكي (3-5 نقاط) تبدأ بـ '💡 خد بالك:'",
        "step3_summary_mindmap": "الخطوة 3: 📝 التلخيص اليدوي في الكراسة + 🧠 الخريطة الذهنية الشجرية المفصلة",
        "step4_questions": "الخطوة 4: 🎯 أسئلة تأكيد الفهم التفاعلية - أسئلة من القصة والنقاط في 'خد بالك منها' (3-5 أسئلة) مع خيارات متعددة وإجابة صحيحة"
      }
    }
  ]
}
  ...
  "quizzes_by_block": [
    {
      ...
      "questions": [
        {
          "question": "السؤال الأول (من القصة أو النقاط)",
